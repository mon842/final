    ...
    return (
        <div className='bg-[#071e34] h-full'>
            ...
            <div className=' py-10 px-12'>
                ...
                <div className="mb-4">
                    <label className='block text-gray-100 text-sm font-bold mb-2' htmlFor="password">password</label>
                    <input
                        className='shadow appearance-none border rounded w-full py-2 px-3 bg-slate-600 text-gray-100 leading-tight focus:outline-none focus:shadow-outline'
                        type="password"
                        name="password"
                ...
                <button onClick={onSignup} className='bg-green-500 hover:bg-green-700 text-white font-bold py-2 px-4 rounded-full mt-10 text-xl'>Add</button>
